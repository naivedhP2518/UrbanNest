        ...
        <div class="container xl">
          ...
          <div class="stats-grid mb-12">
            <div class="stat-card premium-card">
              ...
              <div class="stat-info">
                ...
                <h2 class="stat-value">{{ totalListings }}</h2>
                <div class="stat-badge text-muted" style="background: rgba(0,0,0,0.05); color: #666; font-weight: 500;">
          ...
          <div class="dashboard-main-grid">
            ...
            <div class="inquiries-section premium-card">
              ...
              <div class="inquiry-list mt-6 empty-state text-center py-6" style="color: #666; font-weight: 500;">
                <p>No recent inquiries mapped.</p>
              </div>
            </div>
            ...
            <div class="activity-section premium-card">
              ...
              <div class="activity-list mt-6 empty-state text-center py-6" style="color: #666; font-weight: 500;">
