...
const seedData = async () => {
  try {
    ...
    // Create sample agents (using local auth)
    ...
    const properties = [
      {
        ...
        description:
          'A stunning modern villa located in the heart of Beverly Hills. Features 5 bedrooms, 4 bathrooms, and a private infinity pool.',
        price: 2450000,
      ...
      },
      {
        ...
        description:
          'Breathtaking views of the city skyline from this ultra-luxury penthouse in Manhattan. Floor-to-ceiling windows and premium finishes.',
        price: 8500,
